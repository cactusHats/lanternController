...
int rawDistance[4] = {0, 0, 0, 0};
int fixedDistance[4] = {0, 0, 0, 0};
int elementNum = 0; //ゆらぎデータの要素数
bool humanDetected = false;
int rawIlluminance = 0; //Unityから送られる照度0~100%
...
void loop() {
  ...
  if (Serial.available() > 0) {
    ...
    fixIlluminance(rawIlluminance, illuminanceRate);
  }

  //LEDの制御
  ledControl(ledControlData, elementNum, illuminanceRate);
